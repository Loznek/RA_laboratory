...
export const lists: Lists = {
  Planet: list({
    ...
    fields: {
      ...
      residents: relationship({ ref: 'Race.occupied_planets', many: true }),
      jediFrom: relationship({ ref: 'Jedi.birthPlanet', many: true }),
      natives: relationship({ref: 'Race.origin_planet', many: true}),
      surface: select({
        type: 'string',
        options: [
  ...
  Jedi: list({
    ...
    fields: {
      ...
      master: relationship({ ref: 'Jedi.padawans', many: false }),
      padawans: relationship({ ref: 'Jedi.master', many: true }),
      lightSaber: select({
        type: 'string',
        options: [
